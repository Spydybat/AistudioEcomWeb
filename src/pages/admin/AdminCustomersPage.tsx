      ...
      {loading ? (
        ...
        >
          {filtered.map((customer) => (
            ...
            >
              <td className="px-4 sm:px-6 py-3 font-medium text-black flex items-center gap-3">
                {customer.avatar_url ? (
                  <img
                  ...
                  <div className="w-8 h-8 rounded-full bg-zinc-100 text-black flex items-center justify-center font-bold text-xs">
                    {customer.full_name
              ...
              <div className="flex items-center gap-4">
                {selectedCustomer.avatar_url ? (
                  <img
                    ...
                    className="w-12 h-12 rounded-full border border-zinc-300"
                  />
                ) : (
                  <div className="w-12 h-12 rounded-full bg-zinc-100 text-black flex items-center justify-center font-bold text-lg">
            ...
            <div className="p-4 sm:p-6 space-y-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="bg-zinc-100 rounded-lg p-4 border border-zinc-200">
                  ...
                  <p className="text-sm font-medium text-black text-emerald-400">
              ...
              {/* Order History */}
              <div>
                <h4 className="text-sm uppercase tracking-widest font-mono text-zinc-500 mb-4 border-b border-zinc-200 pb-2">
                  Order History
                </h4>
                {(!selectedCustomer.orders ||
                  selectedCustomer.orders.length === 0) ? (
                  <p className="text-zinc-500 text-sm text-center py-6 bg-zinc-100 rounded-lg border border-zinc-200">
