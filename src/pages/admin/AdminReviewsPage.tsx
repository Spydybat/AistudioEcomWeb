    ...
    <div className="space-y-6 relative">
      ...
      <div className="flex flex-col lg:flex-row gap-4">
        ...
        <div className="flex gap-2 flex-wrap">
          <select
            ...
            className="bg-[#1E1F22] border border-white/5 rounded-lg px-4 py-2.5 text-sm text-zinc-400 focus:outline-none focus:border-indigo-500"
          >
      ...
      {loading ? (
        ...
        >
          {filtered.map((review) => (
            ...
            >
              <td className="px-4 sm:px-6 py-3 text-sm text-white max-w-[180px] truncate">
              ...
              <td className="px-4 sm:px-6 py-3 text-zinc-400 text-xs max-w-[200px] truncate">
                {review.comment}
              </td>
      ...
      {selectedReview && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 overflow-y-auto">
          <div className="bg-[#1E1F22] border border-white/10 rounded-xl w-full max-w-2xl overflow-hidden my-8">
            ...
            <div className="p-4 sm:p-6 space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="bg-white/5 rounded-lg p-4 border border-white/5">
                  ...
                  <select
                    ...
                    className="w-full bg-[#111214] border border-white/10 rounded px-3 py-1.5 text-sm text-white focus:outline-none focus:border-indigo-500"
                  >
              ...
              <div>
                ...
                <div className="bg-white/5 border border-white/5 rounded-lg p-4 text-zinc-300 text-sm leading-relaxed whitespace-pre-wrap">
